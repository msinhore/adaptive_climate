...
try:
    with open(MANIFEST_PATH, "r") as manifest_file:
        ...
        VERSION = _MANIFEST.get("version", "0.1.29")  # Valor padrão caso não encontre
except (FileNotFoundError, json.JSONDecodeError):
    VERSION = "0.1.29"  # Fallback se não conseguir ler o arquivo
...
DEFAULT_PROLONGED_ABSENCE_MINUTES = 60
DEFAULT_AUTO_SHUTDOWN_MINUTES = 120
